...
function f7() {
	...
	document.querySelector('.out-7').textContent = num1 ** num2
}
...
function f10() {
	...
	let out = (document.querySelector('.out-10').textContent = num)
}
...
function f13() {
	let value = document.querySelector('.i-130').value
...
function f14() {
	...
	if (select === '+') out.innerHTML = input1 + input2
	if (select === '-') out.innerHTML = input1 - input2
	if (select === '+') out.innerHTML = input1 + input2
	if (select === '*') out.innerHTML = input1 * input2
	if (select === '/') out.innerHTML = input1 / input2
