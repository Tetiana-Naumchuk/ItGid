...
function t3() {
	...
	request.open(
		'GET',
		'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=5&num2=4',
		true,
	)
	request.send()
	function requestFunction(data) {
...
function t6() {
	...
	request.open(
		'GET',
		'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=5&num2=8',
	)
	request.send()
	function requestFunction(data) {
...
function t9() {
	...
	request.open(
		'GET',
		'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=9&d=1',
		true,
	)
	request.send()
	function requestFunction(data) {
...
function t10() {
	...
	request.send('auth=7859d9d42a8834141d529577207c9596&action=1')
	function requestFunction(data) {
...
function t11() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=2&name=Tetiana')
	function requestFunction(data) {
...
function t12() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=3&num1=2&num2=5')
	function requestFunction(data) {
...
function t13() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=4&num1=1&num2=6')
	function requestFunction(data) {
...
function t14() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=5')
	function requestFunction(data) {
...
function t15() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=6&num1=2&num2=5')
	function requestFunction(data) {
...
function t16() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=7')
	function requestFunction(data) {
...
function t17() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=8&year=1994')
	function requestFunction(data) {
...
function t18() {
	...
	request.open('POST', `${url}`, true)
	request.setRequestHeader('Content-type', 'application/x-www-form-urlencoded')
	request.send('auth=7859d9d42a8834141d529577207c9596&action=9&y=1')
	function requestFunction(data) {
