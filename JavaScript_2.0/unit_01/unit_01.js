...
let changeSpan = document.querySelector('span').innerHTML = 'world';
...
let z1 = 6;
let z2 = 3;
let resultTask14 = document.querySelector('.out-14').innerHTML = `${z1 * z2}`;
...
let y1 = 6;
let y2 = 3;
let resultTask15 = y1 / y2;
document.querySelector('.out-15').innerHTML = `${resultTask15}`
...
let x1 = 'Hello';
let x2 = 5;
let resultTask16 = x1 + x2;
document.querySelector('.out-16').innerHTML = `${resultTask16}`
