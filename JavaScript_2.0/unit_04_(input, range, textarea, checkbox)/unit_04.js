...
function f4() {
    let isChecked = document.querySelector('.i-4');
...
function f5() {
let isChecked = document.querySelector('.i-5');
let isCheckedValue = isChecked.value;
let out = document.querySelector('.out-5');
if (isChecked.checked) {
	out.textContent = isCheckedValue;
} else {
	out.textContent = false;
}
}
...
let out = document.querySelector('.out-10').style.background = input;
}
...
document.querySelector('.i-112').value = input1.value;
}
...
document.querySelector('.out-13').innerHTML = input;
}
...
function f14() {
let t = document.querySelector('.t-14').value;
document.querySelector('.out-14').textContent = t;
}
...
document.querySelector('.t-15').textContent = input;
document.querySelector('.out-15').textContent = input;
}
...
let input = document.querySelector('.i-18').value = select.value;
}
...
let s2 = document.querySelector('.s-202').value = s1.value;
}
