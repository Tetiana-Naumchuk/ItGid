...
let ar3 = ['masha', 'olya', 'ruslana', 'borys', 'ira']
...
let ar6 = ['tania', 'archer', 25, 'november']
...
function f10() {
	let sum = 0
	sum = sum + ar10[1] + ar10[ar10.length - 1]
