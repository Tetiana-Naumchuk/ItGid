...
let a6 = [
	1, 2, 3, 4, 5, 3, 4, 5, 2, 4, 5, 3, 24, 5, 2, 4, 56, 4, 3, 2, 335, 2, 23, 41, 3, 4, 1, 1, 4, 2, 2,
	4, 5, 24, 5, 3, 22, 56,
]
...
const f6 = () => {
	...
	document.querySelector('.out-6').textContent = arr.size
}
...
let s8 = new Set([
	1, 2, 3, 4, 5, 3, 4, 7, 9, 5, 7, 8, 9, 23, 45, 5, 2, 4, 5, 3, 24, 5, 2, 4, 56, 4, 3, 2, 335, 2,
	23, 41, 3, 4, 1, 1, 4, 2, 2, 4, 5, 24, 5, 3, 22, 56,
])
let ar8 = []
const f8 = () => {
	for (let item of s8) {
