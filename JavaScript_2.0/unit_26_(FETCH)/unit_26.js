...
function t3() {
	fetch(
		'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=3&num1=1&num2=4',
	)
		.then(response => {
			return response.text()
		})
...
function t4() {
	fetch(
		'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=4&num1=4&num2=7',
	)
		.then(response => {
			return response.text()
		})
...
function t6() {
	fetch(
		'http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=6&num1=8&num2=9',
	)
		.then(response => {
			return response.text()
		})
...
function t7() {
	fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=7')
		...
		.then(response => {
			document.querySelector('.out-7').innerHTML = `<img src ='${response}'>`
		})
}
...
function t9() {
	fetch('http://getpost.itgid.info/index2.php?auth=7859d9d42a8834141d529577207c9596&action=9&d=1')
		.then(response => {
			return response.text()
		})
		.then(response => {
...
function t12() {
	fetch(`${url}`, {
		...
		body: 'auth=7859d9d42a8834141d529577207c9596&action=3&num1=2&num2=3',
	})
		.then(response => {
			return response.text()
		})
...
function t13() {
	fetch(`${url}`, {
		...
		body: 'auth=7859d9d42a8834141d529577207c9596&action=4&num1=2&num2=8',
	})
		.then(response => {
			return response.text()
		})
...
function t15() {
	fetch(`${url}`, {
		...
		body: 'auth=7859d9d42a8834141d529577207c9596&action=6&num1=1&num2=3',
	})
		.then(response => {
			return response.text()
		})
...
function t18() {
	fetch(`${url}`, {
		...
		body: 'auth=7859d9d42a8834141d529577207c9596&action=9&m=1',
	})
