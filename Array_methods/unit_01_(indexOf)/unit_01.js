...
const f1 = () => {
	...
	if (a1.indexOf(i) !== -1) {
		document.querySelector('.out-1').textContent = a1.indexOf(i);
	} else {
		document.querySelector('.out-1').textContent = a1.indexOf(i);
	}
};
...
const f5 = () => {
	...
	//debugger
	if (a5.indexOf(input, index) !== -1) {
		document.querySelector('.out-5').textContent = a5.indexOf(input, index);
	} else {
...
const f6 = () => {
	...
	if (a6.indexOf(i) !== -1) {
		out.textContent = a6.indexOf(i);
	} else {
		out.textContent = -1;
	}

	//out.textContent = a6.indexOf(3);
	//out.textContent = a6.indexOf('3');
	//out.textContent = a6.indexOf('a');
	//out.textContent = a6.indexOf(5);
	//out.textContent = a6.indexOf(yyt);
};
