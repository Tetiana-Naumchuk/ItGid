...
const f6 = () => {
	...
	if (a6_res === -1) {
		...
		out.innerHTML = a6.length - 1 - a6_res;
	}
};
...
let a8_res = -1;
const f8 = () => {
	a8_res = str8.lastIndexOf(a8_1.toLocaleUpperCase() || a8_res.toUpperCase());
...
const f10 = () => {
	a10_res = [];
	for (let item of a11) {
		if (a10[item] !== undefined) a10_res.push(a10[item]);
	}
