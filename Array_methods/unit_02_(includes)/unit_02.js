...
const f2 = () => {
	...
	let res = a2.includes(i);
	if (res) res = a2.indexOf(i);
	out.textContent = res;
};
...
const f3 = () => {
	...
	let res = a3.flat();
	document.querySelector('.out-3').textContent = res.includes(i);
};
...
const f9 = () => {
	...
	out.innerHTML = a9.includes(i) || a9.includes(upper) || a9.includes(lower) || a9.includes(num);
};
